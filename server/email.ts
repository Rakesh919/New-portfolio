...
//     const apiKey = process.env.SENDGRID_API_KEY || "yfdmdywqnjzzejmp";
...
async function sendWithGmail(data: EmailData): Promise<boolean> {
  try {
    const gmailUser = process.env.GMAIL_USER || 'rakesh30830@gmail.com';
    const gmailPass = process.env.REACT_APP_GMAIL_APP_PASSWORD;
    const toEmail = process.env.TO_EMAIL || 'rakesh88577@gmail.com';
